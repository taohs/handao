...
{{content()}}
    ...
    <form class="form-signin" action="/sign/index" method="post">
        ...
        <input type="text" maxlength="4" name="inputCode" id="inputCode" class="form-control" placeholder="验证码" required="" style="display: inline; margin-bottom: 15px; width: 120px;">
