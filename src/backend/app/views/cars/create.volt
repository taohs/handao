...
<div class="container col-md-8 ">
    ...
    <form class="form-horizontal" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input class="form-control" name="inputYears" id="inputYears" />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10 form-horizontal checkbox">
                ...
                <label class="col-sm-10">
                    <input type="checkbox" class="inputProducts" name="inputProducts[]" value="{{row.id}}" rel="{{row.name}} ￥{{row.member_price}}" >{{row.name}} ￥{{row.member_price}}
                </label>
                {% endfor %}
                {% endif %}
            </div>
